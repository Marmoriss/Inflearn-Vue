<template>
  <main>
    <div class="container py-4">
      <MyButton class="my-button" id="mybutton" @click="sayHello"></MyButton>
      <LabelInput label="이름" data-id="id입니당"></LabelInput>
      <hr />
      ...
      <AppCard>
        ...
        <!-- slot 안써도 암묵적으로 default ~!
        <template #footer>Footer입니다.</template> -->
